...
{
	public class TaxFeeChargesGroup
	{
		[Column("TFC_GROUP_ID")]
		...
		[NotMapped]
		[XmlElement]
		public List<TaxFeeCharges> TaxFeeCharges { get; set; } = new List<TaxFeeCharges>();
		public bool ShouldSerializeTaxFeeCharges() => TaxFeeCharges.Count > 0;
	}
}