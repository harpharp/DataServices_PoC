...
{
	public class TotalConstructionAmountGroup
	{
		...
		[NotMapped]
		[XmlElement]
		public List<TotalConstructionAmount> TotalConstructionAmount { get; set; } = new List<TotalConstructionAmount>();
		public bool ShouldSerializeTotalConstructionAmount() => TotalConstructionAmount.Count > 0;
	}
}