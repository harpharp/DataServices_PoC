...
{
	public class EquivalentFareAmountGroup
	{
		...
		[NotMapped]
		[XmlElement]
		public List<EquivalentFareAmount> EquivalentFareAmount { get; set; } = new List<EquivalentFareAmount>();
		public bool ShouldSerializeEquivalentFareAmount() => EquivalentFareAmount.Count > 0;
	}
}