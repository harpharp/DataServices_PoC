...
{
	public class ExchangedCouponGroup
	{
		...
		[NotMapped]
		[XmlElement]
		public List<ExchangedCoupon> ExchangedCoupon { get; set; } = new List<ExchangedCoupon>();
		public bool ShouldSerializeExchangedCoupon() => ExchangedCoupon.Count > 0;
	}
}