...
{
	public class AmountDetailGroup
	{
		...
		[NotMapped]
		[XmlElement]
		public List<AmountDetail> AmountDetail { get; set; } = new List<AmountDetail>();
		public bool ShouldSerializeAmountDetail() => AmountDetail.Count > 0;
	}
}