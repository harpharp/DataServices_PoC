...
{
	public class CarrierFeeFormofPaymentGroup
	{
		[Column("FOP_GROUP_ID")]
		...
		[NotMapped]
		[XmlElement]
		public List<CarrierFeeFormofPayment> CarrierFeeFormofPayment { get; set; } = new List<CarrierFeeFormofPayment>();
		public bool ShouldSerializeCarrierFeeFormofPayment() => CarrierFeeFormofPayment.Count > 0;
	}
}