...
{
	public class FormofPaymentGroup
	{
		[Column("FOP_GROUP_ID")]
		...
		[NotMapped]
		[XmlElement]
		public List<FormofPayments> FormofPayments { get; set; } = new List<FormofPayments>();
		public bool ShouldSerializeFormofPayments() => FormofPayments.Count > 0;
	}
}