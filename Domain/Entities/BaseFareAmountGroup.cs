...
{
	public class BaseFareAmountGroup
	{
		...
		[NotMapped]
		[XmlElement]
		public List<BaseFareAmount> BaseFareAmount { get; set; } = new List<BaseFareAmount>();
		public bool ShouldSerializeBaseFareAmount() => BaseFareAmount.Count > 0;
	}
}