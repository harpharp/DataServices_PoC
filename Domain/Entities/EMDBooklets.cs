...
namespace Domain.Entities
{
	public class EMDBooklets
	{
		...
		[Column("RELATIVE_TO_SET_NBR")]
		public decimal? RELATIVE_TO_SET_NBR { get; set; }
		public bool ShouldSerializeRELATIVE_TO_SET_NBR() => RELATIVE_TO_SET_NBR.HasValue;
		[Column("INSERT_DT")]
		...
		[NotMapped]
		[XmlElement]
		public List<EMDCoupons> EMDCoupons { get; set; } = new List<EMDCoupons>();
		public bool ShouldSerializeEMDCoupons() => EMDCoupons.Count > 0;
	}
}