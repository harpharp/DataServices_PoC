...
{
	public class CarrierFeeTaxFeeChargesGroup
	{
		[Column("TFC_GROUP_ID")]
		...
		[NotMapped]
		[XmlElement]
		public List<CarrierFeeTaxFeeCharges> CarrierFeeTaxFeeCharges { get; set; } = new List<CarrierFeeTaxFeeCharges>();
		public bool ShouldSerializeCarrierFeeTaxFeeCharges() => CarrierFeeTaxFeeCharges.Count > 0;
	}
}